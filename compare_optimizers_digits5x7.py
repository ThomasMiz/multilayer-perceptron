...
PROBLEM_NAME = 'Digits 5x7'
RUNS_PER_OPTIMIZER = 200

CONFIGURATIONS = {
    'gradient': { 'optimizer': GradientDescentOptimizer(), 'learning_rage': 0.01 },
    'momentum_0.8': { 'optimizer': MomentumOptimizer(alpha=0.8), 'learning_rage': 0.001 },
    'rmsproop_0.9': { 'optimizer': RMSPropOptimizer(gamma=0.9), 'learning_rage': 0.01 },
    'adam_0.9_0.999': { 'optimizer': AdamOptimizer(beta1=0.9, beta2=0.999), 'learning_rage': 0.01 },
}
